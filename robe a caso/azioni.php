<?php
	...
	if(!isset($_SESSION["login"])){
		header("Location: login_back_end.php?from=".$_SERVER["PHP_SELF"]);
	}
...
<!-- -.-.-.-.-.-.-.-.-.-.-.-.-.-.- SCRIVI LA TUA ROBA QUI' -.-.-.-.-.-.-.-.-.-.-.-.-.-.-.- -->
						...
						<div >
							<h1 class="art-postheader"> Area Riservata <button>Logout</button></h1>
							<p align="justify" style="padding:20px;"><button>Vai a statistiche</button></p>
							<form style="text-align: left;" method="POST">
								<div style="display:block; width:300px; height:500px; float:left; padding:20px;">
									<h3 style="color:orange; font-size:170%;"> Utenti </h3>
									<br/>
									<div style="display: block; float:left;" >Filtra:</div> <input type="text" style="width:auto; padding: 0px; float: left;"/>
									<select name="sometext" multiple="multiple" style="width:270px; height:300px;">
										<option>text1</option>
										<option>text2</option>
										<option>text3</option>
										<option>text4</option>
								...
								<div style="display:block; width: 70px; height:500px; float:left; padding:20px;">
									<input type="submit" value="Toggle" />
									<input type="submit" value="Modifica" />
								</div>
							</form>
							<div style="display:block; width:300px; height:500px; float:left; padding:20px;">
								<h3 style="color:orange; font-size:170%;"> Prodotti </h3>
								<br/>
								<div style="display: block; float:left;" >Filtra:</div> 
								<input type="text" style="width:auto; padding: 0px; float: left;"/>
								<select name="sometext" multiple="multiple" style="width:270px; height:300px;">
									<option>text1</option>
									<option>text2</option>
									<option>text3</option>
							...
							<div style="display:block; width: 70px; height:500px; float:left; padding:20px;">
								<button style="position: relative; display:block; top: 100px;">Toggle</button>
								<button style="position: relative; display:block; top: 100px;">Modifica</button>
							</div>
